...
import { setAdminInfo } from '@/redux/actions/adminAuth';
...
function Signin() {
    ...
    const handleSignin = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            const userData: any = await client.fetch(`*[_type == 'authUser' && (username == $emailOrUsername)][0]{
                ...,
            ...
            if (userData) {
                if (userData.password === password) {
                    ...
                    dispatch(setAdminInfo(userData.username, userData._id, userData.pictureUrl));
