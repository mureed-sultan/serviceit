...
function Booking() {
    ...
    const [professionalsNeeded, setProfessionalsNeeded] = useState(1);
                            ...
                            <div className="row">
                                <div className="col-lg-10 mx-auto">
                                    <ul className="step-register row">
                                        <li
                                            className={`col-md-4 ${bookingState === 1 ? "active" : ""
                                                }`}
                                        >
                                        ...
                                        <li
                                            className={`col-md-4 ${bookingState === 2 ? "active" : ""
                                                }`}
                                        >
                                            <div className="multi-step-icon">
                                                <Image
                                        ...
                                        <li
                                            className={`col-md-4 ${bookingState === 3 ? "active" : ""
                                                }`}
                                        >
                                            <div className="multi-step-icon">
                                                <Image
                                                        ...
                                                        <div className="book-form">
                                                            <div className="row">
                                                                <div className="col-md-4">
                                                                    <div className="form-group">
                                                                        <label className="col-form-label">
                                                                            How Much Hours you needed
                                                                        </label>
                                                                        <select className="select" value={hoursNeeded} onChange={(e) => { setHoursNeeded(parseInt(e.target.value)) }}>
                                                                ...
                                                                <div className="col-md-4">
                                                                    <div className="form-group">
                                                                        <label className="col-form-label">
                                                                            How Many Professional You need
                                                                        </label>
                                                                        <select className="select" value={professionalsNeeded} onChange={(e) => { setProfessionalsNeeded(parseInt(e.target.value)) }}>
                                                                            <option value={1}>1</option>
                                                                            <option value={2}>2</option>
                                                                            <option value={3}>3</option>
                                                                            <option value={4}>4</option>
                                                        ...
                                                        <div className="col-lg-6">
                                                            ...
                                                            <div className="summary-box">
                                                                ...
                                                                <div className="booking-summary">
                                                                    <ul className="booking-date">
                                                                        ...
                                                                        <li>
                                                                            Service Provider{" "}
                                                                            <span>Thomas Herzberg</span>
                                                                        </li>
                                                                    </ul>
                                                                    <ul className="booking-date">
                                                                        <li>
                                                                            Subtotal <span>${product.price}.00</span>
                                                                        </li>
                                                                        <li>
                                                            ...
                                                            <div className="save-offer">
                                                                <p>
                                                                    ...
                                                                    Your total saving on this order $5.00
                                                                </p>
                                                            </div>
                                                            <div className="booking-pay">
                                                                ...
                                                                >
                                                                    Proceed to Pay ${product.price + 3}
                                                                </a>
                                                                <a
                                                                    href=" ;"
                                                    ...
                                                    <div className="row align-items-center">
                                                        <div className="col-md-7">
                                                            <div className="booking-done">
                                                                ...
                                                                <p>
                                                                    Your Booking has been Successfully Competed
                                                                </p>
